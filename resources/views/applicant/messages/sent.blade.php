            ...
            <div class="row">
                ...
                <div class="w-1/4">
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="{{ route('applicant.messages.sent') }}" class="block px-4 py-2 rounded-md {{ request()->routeIs('applicant.messages.sent') ? 'bg-blue-700 text-white' : 'text-blue-500 hover:bg-blue-200' }}">
